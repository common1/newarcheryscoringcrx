...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('scoring', '0003_targetfaceindexpage_targetface_targetfacepage'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.RenameModel(
            old_name='CompetitionsLandingPage',
            new_name='RoundIndexPage',
        ),
        migrations.AlterModelOptions(
            name='roundindexpage',
            options={'verbose_name': 'Round Index Page'},
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('round', models.ForeignKey(blank=True, help_text='Round associated with this page (optional, but recommended for proper functionality)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='scoring.round')),
            ],
            options={
